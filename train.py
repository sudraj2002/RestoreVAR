...
import wandb
from utils.modify_ckpt import load_var
...
def train_one_ep(ep: int, is_first_ep: bool, start_it: int, args: arg_util.Args, tb_lg: misc.TensorboardLogger,
    ...
    for it, (inp, degrad, label, restoration_ds, train_sample_idx) in me.log_every(start_it, iters_train, ld_or_itrt,
        ...
        grad_norm, scale_log2 = trainer.train_step(
            ...
            inp_B3HW=inp, degrad_B3HW=degrad, label_B=label, prog_si=prog_si, prog_wp_it=args.pgwp * iters_train,
